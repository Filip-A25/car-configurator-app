...
export function PriceDisplay() {
  ...
  return (
    <section className="flex justify-between items-end max-sm:pt-2 px-5">
      <span className="flex items-center pr-28">
        <h4 className="tracking-widest text-muted-grey text-xs sm:text-sm md:text-lg 3xl:text-2xl">
          TOTAL
        </h4>
      ...
      <span className="text-md sm:text-xl 3xl:text-3xl text-text-default-gray">
        {displayPrice} €
      </span>
    </section>
  );
