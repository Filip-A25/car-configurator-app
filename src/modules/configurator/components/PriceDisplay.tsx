...
export function PriceDisplay() {
  ...
  return (
    <section className="flex justify-between items-end max-sm:py-2 px-5">
      <span className="flex items-center pr-20 max-sm:my-auto">
        <h4 className="tracking-widest text-muted-grey text-xs md:text-md lg:text-lg 3xl:text-xl">
          TOTAL
        </h4>
      ...
      <span className="max-sm:py-2 text-md md:text-xl lg:text-xl 3xl:text-2xl text-text-default-gray">
        {displayPrice} €
      </span>
    </section>
  );
